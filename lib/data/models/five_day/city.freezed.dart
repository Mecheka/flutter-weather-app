...
class _$CityTearOff {
  ...
  _City call(int? id, String? name, Coord? coord, String? country,
      int? population, int? timezone, int? sunrise, int? sunset) {
    return _City(
      id,
      name,
      coord,
...
class _$_City implements _City {
  const _$_City(this.id, this.name, this.coord, this.country, this.population,
...
abstract class _City implements City {
  const factory _City(int? id, String? name, Coord? coord, String? country,
      int? population, int? timezone, int? sunrise, int? sunset) = _$_City;
